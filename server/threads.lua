...
CreateThread(function()
    ...
    plsr.Logger:Info("Jobs", "Salary Thread Starting")
    ...
    while true do
        ...
        for k, v in pairs(plsr.Fetch:AllCharacters()) do
            if v ~= nil then
                ...
                if dutyData and not plsr.State:Player(v:GetData("Source")).gettingPaycheck then
                    ...
                    plsr.Logger:Info("Jobs", string.format("Adding Salary Data For ^3%s^7 (^2%s Minutes^7 - ^3$%s^7)", v:GetData("SID"), workedMinutes, salary))
